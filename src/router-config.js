  ...
  configure() {
    ...
    var appRouterConfig = function(config) {
      ...
      config.map([
          ...
          { route: 'points', name: 'points', moduleId: './points', nav: true, title:'Points', authRoute: true },
          { route: 'signup', name: 'signup', moduleId: './signup', nav: false, title:'Sign Up', authRoute: true },
          { route: 'signin', name: 'signin', moduleId: './signin', nav: false, title:'Sign In', authRoute: true },
